...
/*   Updated: 2025/03/03 17:23:24 by yaykhlf          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*extract_quoted_string(const char *input, int *pos, char quote)
{
	int		start;
	int		end;
	char	*str;
...
static void	handle_operator(const char *input, int *pos, t_token **tokens)
{
